...
\begin{enon}[Injectivité, surjectivité et bijectivité]
...
\begin{enon}
      Soit $X$ un ensemble non dénombrable. On pose $$\mathcal{T}:= \{ A \in P(X) | A \mbox{ est dénombrable ou } X \backslash A \mbox{ est dénombrable}\}.$$
      \begin{enumerate}
              \item Montrer que $\mathcal{T}$ est un tribu sur $X$.
              \item Comparer le tribu engendré par $\{x\}$ et $\mathcal{T}$.
      \end{enumerate}
\end{enon}
...
\begin{preuve}
   Soit $X$ un ensemble non dénombrable. On pose $$\mathcal{T} := \{ A \in P(X) | A \mbox{ est dénombrable ou } X \backslash A \mbox{ est dénombrable}\}.$$
   \begin{enumerate}
          \item Montrons que $\mathcal{T}$ est un tribu sur $X$.
          \begin{itemize}
                     \item On sait que $\emptyset$ et $X \in P(X)$. $\emptyset$ est dénombrable car elle est finie. $X \backslash X = \emptyset$, alors $X\backslash X$ est aussi dénombrable. D'où $\emptyset, X \in \mathcal{T}$.
                     \item Soit $A \in \mathcal{T}$, alors $A \in P(X)$. Par définition de $\mathcal{T}$, $X\backslash A$ est dénombrable. Donc $X \backslash A \in \mathcal{T}$. Elle est alors stable par passage au complémentaire.
                     \item Soit $(A_{n})_{n \in \mathbb{N}} \in \mathcal{T}$. Deux cas s'offrent à nous 
                     \begin{itemize}
                             ...
                             Pour tout $n \in \mathbb{N}$, $\bigcup_{n} X\backslash A_{n}$ est dénombrable. Donc $\bigcup_{n} X\backslash A_{n} \in \mathcal{T}$.
                     \end{itemize}
                     Dans les deux cas on a montré qu'elles sont stable par réunion dénombrable.
          \end{itemize}
          On conclut alors que $\mathcal{T}$ est bien un tribu sur $X$.
   \end{enumerate}
\end{preuve}
\end{document}
