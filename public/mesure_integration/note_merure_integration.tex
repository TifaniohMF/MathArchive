...
\begin{defin}
       $$\mathbf{1}_{A}(x) = \left\{ \begin{array}{c} 1 \mbox{ si } x \in A \\ 0 \mbox{ si } x \not\in A\end{array}\right.$$
\end{defin}

\begin{prop}
       \begin{enumerate}
              \item $\mathbf{1}_{X\backslash A} = 1 - \mathbf{1}_{A}$,
              \item $\mathbf{1}_{A \cap B} = \mathbf{1}_{A} \mathbf{1}_{B}$,
              \item $\mathbf{1}_{A \cup B} = \mathbf{1}_{A} + \mathbf{1}_{B} - \mathbf{1}_{A \cap B}$,
              \item $\mathbf{1}_{A \backslash B} = \mathbf{1}_{A} - \mathbf{1}_{A \cap B}$,
              \item $\mathbf{1}_{A \triangle B} = \mathbf{1}_{A} + \mathbf{1}_{B} \mbox{ mod } 2$.
       \end{enumerate}
\end{prop}
